...
export const authTab = [
    {
        icon:<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" role="img" aria-labelledby="ajjx3jlv27q14ge1a7o9ye111m3m4scd"><title id="ajjx3jlv27q14ge1a7o9ye111m3m4scd">Twitter</title>
    ...
    {
        icon:<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" role="img" aria-labelledby="aqw9353qmzsmc1qpp72gwvxm4bmopshz"><title id="aqw9353qmzsmc1qpp72gwvxm4bmopshz">Facebook</title>
        <path d="M15.402 21v-6.966h2.333l.349-2.708h-2.682V9.598c0-.784.218-1.319 1.342-1.319h1.434V5.857a19.188 19.188 0 00-2.09-.107c-2.067 0-3.482 1.262-3.482 3.58v1.996h-2.338v2.708h2.338V21H4a1 1 0 01-1-1V4a1 1 0 011-1h16a1 1 0 011 1v16a1 1 0 01-1 1h-4.598z"></path>
    </svg>,
        route: 'https://www.facebook.com/hoafngsown/',
    },
    {
        icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" role="img" aria-labelledby="a35kqha53kse8zc3jh5kzmcyywnfdxe0"><title id="a35kqha53kse8zc3jh5kzmcyywnfdxe0">Github</title>
    ...
    route: 'https://github.com/HwangSoon14/clone-dev-to'
    },
    {
        icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" role="img" aria-labelledby="a8myep5k1w76p8ujmur95qfnhh3hur8t"><title id="a8myep5k1w76p8ujmur95qfnhh3hur8t">Instagram</title>
    ...
    route: 'https://www.instagram.com/hoafng.sown/'
    },
    {
        icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" role="img" aria-labelledby="a345o66jh3rhcswuo8lnqarokko568aj"><title id="a345o66jh3rhcswuo8lnqarokko568aj">Twitch</title>
